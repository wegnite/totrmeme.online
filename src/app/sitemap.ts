...
const staticRoutes = [
  ...
  '/meme/totya',
  '/meme/tylenol',
  '/meme/ghostface-ai-picture',
  '/meme/scream-ai-picture',
  '/meme/chicken-stars-meme',
  '/ghost-of-yotei',
  '/generator/totr',
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  > = {
    ...
    '/meme/ghostface-ai-picture': { priority: 0.9, changeFrequency: 'weekly' },
    '/meme/scream-ai-picture': { priority: 0.9, changeFrequency: 'weekly' },
    '/meme/chicken-stars-meme': { priority: 0.85, changeFrequency: 'weekly' },
    '/ghost-of-yotei': { priority: 0.8, changeFrequency: 'weekly' },
    ...
    '/ora-ora-overdrive': { priority: 0.7, changeFrequency: 'weekly' },
