  ...
  return (
    <div className="space-y-16">
      <div className="text-center max-w-3xl mx-auto">
        <h2 className="font-playfair text-3xl lg:text-4xl font-bold mb-6">What is seedream?</h2>
      ...
      {/* Why Choose Us */}
      <div>
        <h2 className="font-playfair text-3xl lg:text-4xl font-bold text-center mb-12">Why Choose seedream?</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardTitle className="text-xl">Your Dreams, Your Rights</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
      ...
      {/* How to Use It */}
      <div>
        <h2 className="font-playfair text-3xl lg:text-4xl font-bold text-center mb-12">How to Plant Your Dreams?</h2>
